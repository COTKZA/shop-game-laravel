...
@section('content')
            ...
            <div class="container mx-auto">
                <div class="flex justify-between">
                    <div class="w-full md:max-w-[50%]">
                        ...
                        <button class="border border-white p-2 rounded-lg mt-2 hover:bg-white hover:text-black text-[16px]">สั่งซื้อเลย</button>
                    </div>
    ...
    <div style="background-image: linear-gradient( rgb(24, 24, 27) 90%)" class="py-20">
        <div class="container mx-auto">
            <div class="border border-emerald-500 p-1 mb-10 rounded-xl bg-emerald-600 shadow-lg">
                <div class="flex items-center">
                    <h1 class="p-2 rounded-xl bg-emerald-700 text-white font-bold mr-4">
                        ประกาศ
                    </h1>
                    <marquee behavior="scroll" direction="right" class="text-white font-medium py-2">
        ...
        <div class="container mx-auto">
            ...
            <div class="flex justify-center items-cetner">
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-3">
                    <div class="border border-zinc-500 px-30 py-10 text-center rounded-xl skeleton">
